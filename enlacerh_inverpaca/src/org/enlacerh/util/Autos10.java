	   ...
	   public static void findfiles(String imagen){
	     ...
	     **/ 	
	      ...
	      //Reconoce la base de datos de conección para ejecutar el query correspondiente a cada uno
	        ...
	        String erhaudit = "";
	  		erhaudit = "INSERT INTO ERHAUDIT VALUES ('AUTOS10: IMPUESTOS', 'CONSULTA DE HISTORICO IMPUESTO SOBRE LA RENTA','" + login + "',to_char(sysdate,'dd/mm/yyyy'),to_char(sysdate,'HH:MI AM'))";
